...
+ '<div class="header"><div class="logo">ALPHA SCHOOL</div><div class="sub">HR &amp; Payroll Department</div></div>'
...
+ '<div class="info-item"><div class="info-label">Payroll No.</div><div class="info-value">' + ((record as any).payroll_number || '-') + '</div></div>'
+ '<div class="info-item"><div class="info-label">Status</div><div class="info-value">' + record.status + '</div></div>'
+ '</div>'
+ '<div class="ed"><div><div class="sec">Earnings</div><table>'
...
+ '<script>window.onload=function(){window.print();}<\/script></body></html>');
        ...
        if ((record as any).payroll_number) a(ctr('Payroll No: ' + (record as any).payroll_number));
...
+ '</body></html>');
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, fontFamily: T.fontBase }}>
            ...
            <button onClick={function(){ handlePrint('thermal'); }} style={{
            ...
            <button onClick={function(){ handlePrint('a4'); }} style={{
                display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
...
function PayrollForm({ staff, advances, onSave, onClose, editRecord }: {
    ...
    const [payDate, setPayDate] = useState((editRecord as any)?.payment_date || '');
