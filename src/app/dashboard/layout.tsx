...
const menuGroups = [
...

    {
        ...
        items: [
            ...
            { href: '/dashboard/exams/principal-report',     label: '📋 Principal\'s Report',       icon: FiFileText,    perm: 'exams' },
            ...
            { href: '/dashboard/exams/release-results',      label: '📱 Release Results to Mobile',   icon: FiSmartphone,  perm: 'exams' },
    ...
    },
    {
        ...
        items: [
            ...
            { href: '/dashboard/super-admin', label: '👑 Super Admin — User Management', icon: FiShield, perm: 'super-admin' },
...
const ALL_PERMISSIONS: Record<string, boolean> = [
    'dashboard','students','fees','exams','curriculum','timetable','subjects',
    'attendance','discipline','leave-out','reports','users','settings','income',
    'remedial','super-admin','staff','stores','library','transport','visitors',
    'hostel','health','assets','communication','payroll','analytics','audit',
