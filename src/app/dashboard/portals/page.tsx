              ...
              <div>
                {uForm.user_type==='principal'?(
                  <>
                    ...
                    <div className="w-full px-4 py-3 bg-red-50/80 border border-red-200 rounded-xl text-sm text-red-700 font-bold flex items-center gap-2">
                      <span>👑</span> Principal — Full School Access
                    </div>
                    <p className="text-[10px] text-red-500 mt-1.5 flex items-center gap-1">⚠️ Only ONE principal account should exist per school</p>
                  </>
                ):uForm.user_type==='teacher'?(
                  <>
